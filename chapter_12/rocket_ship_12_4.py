#### TRY IT YOURSELF - Chapter 12 - Page 246 - Rocket Ship Image
import pygame 
...
class Ship:
    ...
    def __init__(self, r_game):
        ...
        # Store a decimal value for the ship's horizontal and verticle position.
    ...
    def update(self):
        """Update the ship's positon based on the movement flags."""
